...
import {
  CSSTransition,
  TimesIcon
} from "./chunk-C56J5X4W.js";
import {
  IconBase
} from "./chunk-MNV5QAAD.js";
import {
  Portal
} from "./chunk-2DW5DCWM.js";
import "./chunk-MKERC6XI.js";
import {
  ComponentBase,
...
var RefreshIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SearchMinusIcon = React3.memo(React3.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var SearchPlusIcon = React4.memo(React4.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var UndoIcon = React5.memo(React5.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var DownloadIcon = React6.memo(React6.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var Image = React6.memo(React6.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React6.useContext(PrimeReactContext);
  var props = ImageBase.getProps(inProps, context);
  var _React$useState = React6.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), maskVisibleState = _React$useState2[0], setMaskVisibleState = _React$useState2[1];
  var _React$useState3 = React6.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), previewVisibleState = _React$useState4[0], setPreviewVisibleState = _React$useState4[1];
  var _React$useState5 = React6.useState(0), _React$useState6 = _slicedToArray(_React$useState5, 2), rotateState = _React$useState6[0], setRotateState = _React$useState6[1];
  var _React$useState7 = React6.useState(1), _React$useState8 = _slicedToArray(_React$useState7, 2), scaleState = _React$useState8[0], setScaleState = _React$useState8[1];
  var elementRef = React6.useRef(null);
  var imageRef = React6.useRef(null);
  var maskRef = React6.useRef(null);
  var previewRef = React6.useRef(null);
  var previewButton = React6.useRef(null);
  ...
  var createPreview = function createPreview2() {
    ...
    if (props.preview) {
      return React6.createElement("button", buttonProps, content);
    }
    return null;
  };
  var createElement7 = function createElement8() {
    ...
    var downloadIcon = IconUtils.getJSXIcon(props.downloadIcon || React6.createElement(DownloadIcon, null), _objectSpread({}, downloadIconProps), {
      props
    });
    var rotateRightIcon = IconUtils.getJSXIcon(props.rotateRightIcon || React6.createElement(RefreshIcon, null), _objectSpread({}, rotateRightIconProps), {
      props
    });
    var rotateLeftIcon = IconUtils.getJSXIcon(props.rotateLeftIcon || React6.createElement(UndoIcon, null), _objectSpread({}, rotateLeftIconProps), {
      props
    });
    var zoomOutIcon = IconUtils.getJSXIcon(props.zoomOutIcon || React6.createElement(SearchMinusIcon, null), _objectSpread({}, zoomOutIconProps), {
      props
    });
    var zoomInIcon = IconUtils.getJSXIcon(props.zoomInIcon || React6.createElement(SearchPlusIcon, null), _objectSpread({}, zoomInIconProps), {
      props
    });
    var closeIcon = IconUtils.getJSXIcon(props.closeIcon || React6.createElement(TimesIcon, null), _objectSpread({}, closeIconProps), {
      props
    });
    ...
    return React6.createElement("div", maskProps, React6.createElement("div", toolbarProps, downloadable && React6.createElement("button", downloadButtonProps, downloadIcon), React6.createElement("button", rotateRightButtonProps, rotateRightIcon), React6.createElement("button", rotateLeftButtonProps, rotateLeftIcon), React6.createElement("button", zoomOutButtonProps, zoomOutIcon), React6.createElement("button", zoomInButtonProps, zoomInIcon), React6.createElement("button", closeButtonProps, closeIcon)), React6.createElement(CSSTransition, _extends6({
      nodeRef: previewRef
    }, transitionProps), React6.createElement("div", previewContainerProps, React6.createElement("img", _extends6({
      alt: alt2
    }, previewProps)))));
  };
  ...
  var icon = props.indicatorIcon || React6.createElement(EyeIcon, iconProp);
  ...
  var image = props.src && React6.createElement("img", _extends6({}, imageProp, {
    alt
  }));
  ...
  return React6.createElement("span", rootProps, image, preview2, maskVisibleState && React6.createElement(Portal, {
    element,
